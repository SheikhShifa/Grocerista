    ...
    render(){
        ...
        <div className="footer">
            <div  >
                ...
                <td className="float-end">
                    <div className="nameColor">
                        ...
                        <img
                            ...
                            alt="Download GROCERISTA app for Android from Play Store"
                        />
                        </a>
                        <a><img src="https://www.jiomart.com/images/cms/wysiwyg/app-icons/ios_store.png"
                            alt="Download GROCERISTA app for iOs from App Store"/></a>
                    </div>{' '}
                </td>
                </tr>
                </table>
                ...
                <div class="copyright">
                    <div>© By Shifa Shimanshu & Mayank - CDAC PROJECT NOIDA</div>
                </div>
            </div>

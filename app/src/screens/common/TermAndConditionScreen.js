...
const TermAndConditionScreen = () => {
    return (
        <div>
            ...
            <p>GROCERISTA is the licensed owner of the brand mygreenmart.in 
                and the website mygreenmart.in (”The Site”).GROCERISTA
                 respects your privacy. This Privacy Policy provides succinctly 
                 the manner your data is collected and used by GROCERISTA on 
                 ...
                 use of your data by GROCERISTA in the manner provided in this 
                 Privacy Policy.
            </p>
            <br/>
            <h5>Services overview
</h5>
            <p>As part of the registration process on the Site, GROCERISTA
            ...
            <p>GROCERISTA grants you a limited sub-license to access and make 
                ...
                written consent of GROCERISTA. This license does not include 
                ...
                express written consent of GROCERISTA. You may not frame or utilize 
                ...
                of GROCERISTA and its affiliates without express written consent. 
                You may not use any meta tags or any other “hidden text” utilizing the 
                Site’s or GROCERISTA's name or MGM’s name or trademarks without the 
                express written consent of GROCERISTA. Any unauthorized use terminates 
                the permission or license granted by GROCERISTA</p>
            <br/>
        </div>
        </div>
    );
